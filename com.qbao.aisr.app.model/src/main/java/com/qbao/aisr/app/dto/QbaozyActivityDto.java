 ...
 */
public class QbaozyActivityDto implements Serializable {
    ...
    private List<QbaozyClassesDto> classesList;
	...
	public List<QbaozyClassesDto> getClassesList() {
		return classesList;
	}

	public void setClassesList(List<QbaozyClassesDto> classesList) {
